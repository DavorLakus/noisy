...
protocol NoisyAPIProtocol {
    ...
    func getRecentlyPlayed(limit: Int, offset: Int) -> AnyPublisher<Data, Error>
    ...
    func addTrackToQueue(_ trackUri: String) -> AnyPublisher<Data, Error>
...
extension NoisyService {
    ...
    func getRecentlyPlayed(limit: Int, offset: Int) -> AnyPublisher<Data, Error> {
        NetworkingManager.performRequest(.recentlyPlayed(limit: limit, offset: offset))
    }
    ...
    func addTrackToQueue(_ trackUri: String) -> AnyPublisher<Data, Error> {
        NetworkingManager.performRequest(.addToQueue(trackUri: trackUri))
    }
